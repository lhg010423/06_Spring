...
public class MemberController {
	...
	public String login(Member inputMember,
		...
		if(loginMember != null) {
			...
			// 아이디저장하고 로그인하면 쿠키에 뜸 f12 -> Application -> Cookies -> 주소 확인 -> saveId가 있음
	...
	/** 회원 가입
	 * @param inputMember : (커맨드객체) 입력된 회원정보 (memberEmail. memberPw, memberNickname,
	...
	public String signup(Member inputMember,
						...
						RedirectAttributes ra) {
	// form으로 보낸 동기식이고 forward나 redirect로 주소를 보내야하니 String이다
