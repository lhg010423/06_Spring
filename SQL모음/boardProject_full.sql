...
-- 단, 최신글이 제일 위에 존재
-- 몇 초/분/시간 전 또는 YYY-MM-DD 형식으로 작성일 조회
-- + 댓글 개수
-- + 좋아요 개수
...
VALUES(1, 2002); -- 1번 회원이 1998번 글에 좋아요를 클릭함
...
INSERT INTO "COMMENT"
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 1', DEFAULT, DEFAULT, 2005, 1, NULL); -- 2001

INSERT INTO "COMMENT"
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT, DEFAULT, 2005, 1, NULL); -- 2002

INSERT INTO "COMMENT"
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 3', DEFAULT, DEFAULT, 2005, 1, NULL); -- 2003
...
-- 부모 댓글 1의 자식 댓글
INSERT INTO "COMMENT"
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 1의 자식 1', DEFAULT, DEFAULT, 2005, 1, 2001);

INSERT INTO "COMMENT"
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 1의 자식 2', DEFAULT, DEFAULT, 2005, 1, 2001);


-- 부도 댓글 2의 자식 댓글
INSERT INTO "COMMENT"
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 2의 자식 1', DEFAULT, DEFAULT, 2005, 1, 2002);


-- 부모 댓글 2의 자식 1의 자식 댓글
INSERT INTO "COMMENT"
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 2의 자식 1의 자식!!!', DEFAULT, DEFAULT, 2005, 1, 2010);
...
-----------------------------------------------------------------------------
SELECT LEVEL, C.* FROM -- 레벨을 포함해서 C의 모든 조회결과를 검색한다
(SELECT COMMENT_NO, COMMENT_CONTENT,
		    TO_CHAR(COMMENT_WRITE_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') COMMENT_WRITE_DATE,
		    BOARD_NO, MEMBER_NO, MEMBER_NICKNAME, PROFILE_IMG, PARENT_COMMENT_NO, COMMENT_DEL_FL
		FROM "COMMENT"
		JOIN MEMBER USING(MEMBER_NO)
		WHERE BOARD_NO = 2005) C -- ()안의 조회 결과를 C라고 부른다
WHERE COMMENT_DEL_FL = 'N' -- 현재 댓글이 삭제되지 않았을 때

OR 0 != (SELECT COUNT(*) FROM "COMMENT" SUB
				WHERE SUB.PARENT_COMMENT_NO = C.COMMENT_NO
				AND COMMENT_DEL_FL = 'N') -- 상관서브쿼리
...
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, "brothernine423@gmail.com", "pass01", "bronine", NULL, NULL, NULL, DEFAULT, DEFAULT, 1);
