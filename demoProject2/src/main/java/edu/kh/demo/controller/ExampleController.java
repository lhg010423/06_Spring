...
public class ExampleController {
	 ...
	 * - 기본 scope : request
	 * 
	 * - @SessionAttributes 와 함께 사용 시 session scope 로 변환한다
	 * 
	 * [기본 사용법]
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		// 단일 값(숫자, 문자열) html을 이용해서 html로 전달
		...
		// List<Student> 객체 Model을 이요해서 html로 전달
	...
	public String ex3(Model model) {
		...
		// Model : 스프링에서 사용하는 데이터 전달용 객체 (request scope)
	...
	public String ex4(Model model) {
		...
		Student std = new Student("67890", "잠만보", 2);
